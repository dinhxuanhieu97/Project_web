...
<body class="bg-light">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<a class="nav-link active" aria-current="page" href="cau1.html">Cau 1</a>
					</li>
	...
	<div class="container mt-5">
		<div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
			...
			<input type="checkbox" class="btn-check btn-category" id="cb-<?php echo $item['id']; ?>" autocomplete="off"
			...
			<div class="col-md-12">
				<div class="row product-container">
					...
					<div class="col-md-3">
						...
						<span class="badge text-bg-warning" id="view-<?php echo $item['id']; ?>"><i class="bi bi-eye-fill"></i>
							<?php echo $item['views']; ?></span>
